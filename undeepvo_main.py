...
parser.add_argument('--alpha_image_loss',          type=float, help='weight between SSIM and L1 in the image loss', default=0.08)
...
def train(params):
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        dataloader = UndeepvoDataloader(args.data_path, args.filenames_file, params, args.dataset, args.mode)
